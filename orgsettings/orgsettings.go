// Package orgsettings models the unauthenticated org-branding/config lookup
// used by the client shell (colours, logo, name), plus the organization-wide
// settings that grow alongside it — named for that future scope rather than
// just what it holds today (DEV-1683).
package orgsettings
